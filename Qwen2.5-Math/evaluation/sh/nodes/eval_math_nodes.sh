...
max_tokens=32768
top_p=1
benchmarks="math500,olympiadbench,aime24,amc23"
# output_suffix=""
...
eval_script_path="Qwen2.5-Math/evaluation/sh/nodes/eval.sh"

base_checkpoint_path="${base_storage_dir}/${RUN_NAME}"
init_model_path="${INIT_MODEL_PATH}"

chmod +x Qwen2.5-Math/evaluation/sh/nodes/convert_and_evaluate_gpu_nodes.sh
...
if [ "$just_wandb" != "true" ]; then
    ...
    bash Qwen2.5-Math/evaluation/sh/nodes/convert_and_evaluate_gpu_nodes.sh \
    "$eval_script_path" \
