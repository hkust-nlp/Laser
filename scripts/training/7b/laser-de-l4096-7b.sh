...
export RUN_NAME=Laser-Training-7B
...
UPPER_BOUND=$MAX_RESPONSE_LENGTH
LOWER_BOUND=4096
INTERVAL=1024
ROUND_METHOD=floor
...
PYTHONUNBUFFERED=1 python -m verl.trainer.main_ppo \
    ...
    length_penalty.upper_bound=$UPPER_BOUND \
    length_penalty.lower_bound=$LOWER_BOUND \
    length_penalty.interval=$INTERVAL \
    length_penalty.round_method=$ROUND_METHOD \
