...
def extract_solution_with_thought(solution_str):
    
    model_output = solution_str
    
    if THOUGHT_DELIMITER_START in solution_str and THOUGHT_DELIMITER_END in solution_str:
...
def compute_score(solution_str, ground_truth, method='strict'):
    ...
    extract_answer, is_boxed_matched = extract_solution_with_thought(solution_str=solution_str)
