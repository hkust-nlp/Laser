...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        used_response_length = self.config.response_length
        if "max_tokens" in prompts.meta_info:
            assert prompts.meta_info["max_tokens"] <= self.config.response_length, "max_tokens should be less than or equal to the response_length"
            print(f"Newly set max_tokens: {prompts.meta_info['max_tokens']}")
            kwargs["max_tokens"] = prompts.meta_info["max_tokens"]
            used_response_length = prompts.meta_info["max_tokens"]
